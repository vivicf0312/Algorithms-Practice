...
public final class ScheduledExecutorServiceExample {
	...
	public static void main(String... aArgs) throws InterruptedException {
		log("Main started.");
		ScheduledExecutorServiceExample alarmClock = new ScheduledExecutorServiceExample(
				3, 1, 20);
	...
	ScheduledExecutorServiceExample(long aInitialDelay,
			long aDelayBetweenBeeps, long aStopAfter) {
